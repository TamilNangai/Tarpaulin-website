  ...
  return (
    ...
    <div className="bg-white w-4/3">
      <h2 className=" mt-3 text-[45px] text-center font-bold font-[Abhaya-Libre]">Contact us</h2>
        {/* Left */}
          <h3 className="text-[31px] font-[Be-Vietnam] font-semibold mt-10 px-5 ">OFFICE DETAILS</h3>
           <div className="flex flex-col mt-5 lg:flex-row justify-between ">
               <div className="flex flex-row md:w-full lg:w-1/2  mx-20">
                     <div className='space-y-2 '>   
                      ...
                      <div className='space-y-6'>
                         <p className="text-[23px] items-center px-5"> 995082301558</p>
                         <p className="text-[20px] items-center px-5"> Desflyer.tech@gmail.com</p><br></br>
        ...
        {/* Right */}
        <div className="flex flex-col bg-gray-200 rounded-3xl px-3 h-fit shadow-md mx-5">
          <h3 className=" font-[Abhaya-Libre] text-center text-[40px] font-semibold mb-2">Chat With Us</h3>
          <div className="flex flex-row mt-2 gap-0 h-fit lg:w-full">
          <form className="space-y-1 w-fit">
            ...
            <input placeholder="Message" className="w-[350px] p-2 border rounded-xl  bg-gray-200 border-black"></input>
              ...
              <div className=" felx-col lg:w-1/3 mt-2 mb-12 pl-2  bg-black text-white rounded-xl">
                <p className="p-2 text-center text-[13px]">Tarpaulins are used across a wide range of applications, from the construction sector to agriculture, from home use to commercial use. </p>
                <img clasNmae="w-5 " src={image} alt="image"/>
                <p className="p-2 text-center text-[13px]"> In construction projects, tarpaulins are used to protect materials and equipment, while in agriculture, they cover products to provide protection.</p>
               </div>
               </div>
          </div>
             </div>
